...
export default function showcard({
  ...
  return (
    <div>
      <Card
        className="m-10 border-2 hover:shadow-lg shadow-lg shadow-pink-400/50 transform transition duration-500 ease-in-out hover:scale-105 hover:animate-colorChange cursor-pointer cdcs"
        sx={{
          width: 320,
          transition: "0.3s",
